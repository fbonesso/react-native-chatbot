...
import { Dimensions, TextInput, View, ScrollView, Platform } from 'react-native';
  ...
  render() {
    ...
    return (
      <View style={{flex: 1, backgroundColor: '#eeeeee'}}>
        <KeyboardAwareScrollView enableOnAndroid={true} extraScrollHeight={10} contentContainerStyle={{flexGrow: 1}} scrollEnabled={false}>
          <ScrollView
            className="rsc-content"
            style={[scrollViewStyle, {paddingTop: 10}]}
